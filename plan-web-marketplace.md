...
- [ ] **Eliminar todo lo relacionado con "AMARE"** — lista base de archivos detectados a revisar uno por uno:
  - [ ] `app/services/AmareModifierSyncService.php` — **revisar primero**, puede tener lógica de sincronización de modificadores que se necesita conservar (renombrada), no solo borrar
