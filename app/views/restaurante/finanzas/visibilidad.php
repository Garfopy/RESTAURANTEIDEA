...
<div class="visibility-wrap">
  <section class="visibility-hero">
    <h1>Superadministraci&oacute;n</h1>
    <p>Controla qué periodo financiero pueden consultar los demás niveles. Las ventas, tickets, gastos, retiros, cortes, facturas, historial y puntos permanecen guardados sin modificación. El superadministrador siempre conserva la vista completa.</p>
      ...
      <div class="visibility-list">
        ...
        <div class="visibility-event">
          ...
          <span>
            ...
            · <?= htmlspecialchars((string)($evento['usuario_nombre'] ?? 'Superadministrador')) ?>
