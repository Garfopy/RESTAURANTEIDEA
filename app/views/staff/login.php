...
<div class="staff-login-wrap">
  <div class="staff-login-card">
    ...
    <div style="text-align:center;margin-bottom:28px">
      ...
      <?php else: ?>
      <div style="width:56px;height:56px;border-radius:14px;background:var(--cp);
                  display:flex;align-items:center;justify-content:center;
                  font-size:1.6rem;font-weight:800;color:#fff;margin:0 auto 10px">
      ...
      <div style="font-size:.8rem;color:#9CA3AF;margin-top:3px">Portal de acceso staff</div>
    </div>
